// type definition
#let frameline(height: 3em, thick: .05em, stroke: black, is-short: false, is-assume: false, assume-length: 2.25em, assume-thick: .05em, assume-stroke: black) = {
  (
    height: height,
    thick: thick,
    stroke: stroke,
